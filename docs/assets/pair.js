...
(function(){
  ...
  var NOTE = {
    ...
    AO: { same:"自分への確信の強さが同じです。待たされる／急かされるが起きにくい。",
          diff:"自分への確信の強さが違います。迷わず決める人と、決めたあとも考え直す人。急かすでも待つでもなく、「いつまでに決めるか」を先に置くと、どちらも消耗しません。" },
    HC: { same:"人への構えが同じです。距離の詰め方に説明がいりません。",
          diff:"人への構えが違います。まず信じて開く人と、見きわめてから近づく人。冷たいわけでも無防備なわけでもなく、既定値が違うだけ。そう言葉にしておくと誤解が減ります。" }
  };
